...
| 模块 | 说明 |
|---|---|
| 打卡 | 拍照打卡 + 水印（时间/地点/姓名工号）+ 定位，支持上下班两个时段 |
| 考勤记录 | 月历视图，迟到/早退/请假/节假日/加班分别用不同颜色标记，支持点开当天明细 |
| 申请中心 | 补卡 / 请假 / 加班 / 班次调整 / 离职 5 类申请，入口按钮 + 独立子页面 |
| 工资条 | 按半月结（Cutoff）展示应发/扣款明细，含 Demo 身份校验环节 |
| 我的 | 编辑头像/姓名/性别、切换中英文、重置 Demo 数据、退出登录 |
